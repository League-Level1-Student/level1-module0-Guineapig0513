...
public class DrumKit implements MouseListener {
    ...
    public void run() {
        ...
        String hm = "cymbal.jpg";
        ah = createLabelImage(hm);
        e.add(ah);
        ha.pack();
        ah.addMouseListener(this);
    }
